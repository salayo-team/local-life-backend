...
public class QPayment extends EntityPathBase<Payment> {
    ...
    private static final long serialVersionUID = 1091779860L;
    ...
    public final StringPath paymentFailedReason = createString("paymentFailedReason");

    public final StringPath paymentMethodType = createString("paymentMethodType");

    public final EnumPath<com.salayo.locallifebackend.domain.payment.enums.PaymentStatus> paymentStatus = createEnum("paymentStatus", com.salayo.locallifebackend.domain.payment.enums.PaymentStatus.class);

    public final StringPath pgTid = createString("pgTid");

    public final DateTimePath<java.time.LocalDateTime> refundAttemptedAt = createDateTime("refundAttemptedAt", java.time.LocalDateTime.class);

    public final com.salayo.locallifebackend.domain.reservation.entity.QReservation reservation;
    ...
    public QPayment(Class<? extends Payment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reservation = inits.isInitialized("reservation") ? new com.salayo.locallifebackend.domain.reservation.entity.QReservation(forProperty("reservation"), inits.get("reservation")) : null;
    }
