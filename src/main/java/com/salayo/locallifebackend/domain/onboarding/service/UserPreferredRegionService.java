...
/**
 * 사용자 선호 지역 관리 Service 선호 지역 조회, 수정, 자동 매핑 기능 제공
 */
@Slf4j
@Service
public class UserPreferredRegionService {
	...
	/**
	 * 사용자 선호 지역 업데이트 (지역 특징 재선택) 마이페이지에서 선호 지역 변경 시 사용
	 */
	@Transactional
	...
	/**
	 * 온보딩 과정에서 선호 지역 설정 OnboardingService에서 호출하여 사용
	 */
	@Transactional
